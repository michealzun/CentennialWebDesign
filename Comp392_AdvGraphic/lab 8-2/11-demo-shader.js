...
const _shader=Shaders.BasicShader3;
...
function createGeometry() {
    ...
    _shader.uniforms.texture.value=new THREE.TextureLoader().load('https://i1.wp.com/phillyinfluencer.com/wp-content/uploads/2018/08/hiphop.jpg?w=1920');
...
function render() {
    ...
    _shader.uniforms.time.value = clock.getElapsedTime();
